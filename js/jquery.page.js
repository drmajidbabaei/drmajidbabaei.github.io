...
(function (window, undefined) {
  ...
  var Page = (function () {
    var $container = $("#container"),
      ...
      $articles = $container
        .find("div.content-wrapper > article")
        .not(".noscroll"),
      ...
      _goto = function (chapter) {
        ...
        var chapter =
            chapter || History.getState().url.queryStringToJSON().page,
        ...
        if ($article.length) {
          ...
          $elScroller
            .stop()
            .animate(param, animation.speed, animation.easing, function () {
            ...
            if (isipad > -1 || ismobile > -1) {
              ...
              $("article.content")
                ...
                .each(function () {
                  ...
                  if ($(window).width() > 767) {
                    aJSP === undefined
                      ? $article.jScrollPane(scrollOptions)
                      : aJSP.reinitialise();

                    _initArticleEvents();
                  } else {
                    // destroy article's custom scroll if screen size <= 715px
                    if (aJSP !== undefined) aJSP.destroy();
      ...
      _initMenuEvents = function () {
        ...
        $toTop.on("click", function (event) {
          $("html, body")
            .stop()
            .animate({ scrollTop: 0 }, animation.speed, animation.easing);
